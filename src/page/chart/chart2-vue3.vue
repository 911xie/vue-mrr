<template>
    <el-row class="home" :gutter="20">
        <div id="barStacked" style="width: 100%; height: 270px;margin-bottom: 20px;background:rgba(236, 242, 254, 1);"></div>
        <div id="barStackedTwo" style="width: 100%;height: 270px;background:rgba(236, 242, 254, 1);"></div>
    </el-row>
</template>
<script>
